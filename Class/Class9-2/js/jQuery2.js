...
$("#_hideD").click(function(){
  $(".smallGridBug div:first-child p").hide();
});

$("#_showD").click(function(){
  $(".smallGridBug div:first-child p").show();
});

$("#_toggleD").click( function(){
  $(".smallGridBug div:nth-child(2) p").toggle();
});

$("#_htmlD").click(function() {
  $(".smallGridBug div:nth-child(3) p").html("Hi");
});

$("#_cssD").click(function(){
  $(".smallGridBug div:nth-child(4)").css("color", "red");
});
